...
NOTEDLY	rmb	1		Song playback variables
	ifdef DAC
NOTESTP	rmb	1
NOTECNT	rmb	2
NOTEINC	rmb	2
...
INIT	equ	*		Basic one-time setup goes here!
	...
	ifdef MON09
	lda	#$03		Switch SCS! to proper slot on MPI
	sta	$ff7f
	endif
...
*
* Data for "COPYRIGHT 2019"
*
CPYSTR1	fcb	$60,$43,$4f,$50,$59,$52,$49,$47
	fcb	$48,$54,$60,$72,$70,$71,$79,$60
CPYS1ND	equ	*
